...
def main():
    ...
    config = {
        "data_dir": str(script_dir / "data" / "preprocessed_data"),
        "batch_size": 32,
        "window_size": 1024,
        "latent_dim": 256,
        "num_epochs": 100,
        ...
        "aug_scale_high": 1.1,
        "augment_repeat": 20,
        "use_raw_modalities": True,
        "dropout": 0.0,
        "max_grad_norm": 1.0,
        "use_all_data": True,
        "train_ratio": 0.7,
        "val_ratio": 0.0,
        "oversample_labels": [0, 1, 2, 3],
        "oversample_ratio": 3.0,
        "oversample_ratio_ball": 5.0,
        "temperature": 0.7,
        "lstm_hidden": 192,
        "lstm_layers": 1,
        ...
        "feat_weight": 0.4,
        "best_epoch_cap": 85,
        "best_epoch_fixed": None,
        "boost_factor_healthy": 1.8,
        "boost_factor_inner": 1.8,
        "boost_factor_outer": 1.8,
        "boost_factor_ball": 3.0,
        "contrastive_loss_weight": 0.1,
        "pretrained_path": "",
        "pretrained_freeze_encoder_epochs": 5,
        "eval_seeds": None,
        "save_best_path": str(script_dir / "outputs" / "best_ReFusion.pth"),
